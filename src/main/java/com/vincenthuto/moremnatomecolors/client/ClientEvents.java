...
import com.vincenthuto.moremnatomecolors.MoreMnATomeColors;
...
@Mod.EventBusSubscriber(modid = MoreMnATomeColors.MODID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
